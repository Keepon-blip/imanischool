...
<body>
    <div class="container serv-intro pt-4 ps-5">
        <h3>Classes</h3>
        <div class="line"></div>
        <h1>Drum Lessons</h1>
    </div>
    <div class="container b-drum">
        <div class="row mt-5">
            <div class="col-lg-6 p-5">
                <img src="img/drums.jpg" alt="" width="500" class="book-drum-img">
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Book Drum Lessons</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="form" action="book-drum.php" method="POST">
