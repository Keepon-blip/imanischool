...
<body>
    <div class="container serv-m-intro pt-4 ps-5">
        <h3>Classes</h3>
        <div class="line"></div>
        <h1>Music Theory & Vocal Lessons</h1>
    </div>
    <div class="container b-drum">
        <div class="row mt-5">
            <div class="col-lg-6 p-5">
                <img src="img/bmusic.jpg" alt="" width="500" class="book-drum-img">
            </div>
            <div class="col-lg-6 text-white p-5 rounded" style="background-color: #0C2730;    filter: drop-shadow(10px 10px 10px rgba(0, 0, 0, 0.6));">
                <h3>Music Theory & Vocal Lessons</h3>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Book Music Lessons</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="form" action="book-music.php" method="POST">
